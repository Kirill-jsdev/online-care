    ...
    <div className="flex justify-between z-20 items-center px-4 sm:px-8 py-4 absolute w-full">
      ...
      <nav className="hidden lg:block text-white">
        <ul className="flex gap-8">
          ...
          <li>
            <a href="#how-it-works" className="cursor-pointer hover:text-white/80 transition-colors">
              Как это работает
            </a>
          </li>
          <li>
      ...
      >
        <ul className="flex flex-col gap-4 pt-20 px-6">
          ...
          <li>
            <a
              href="#how-it-works"
              className="block py-2 text-white hover:text-white/80 transition-colors text-lg"
